...
public class RWorkspace {
    ...
    ExceptionReport {
        ...
        File workspacePath = new File(System.getProperty("java.io.tmpdir"), UUID.randomUUID().toString());
        try {
            FileUtils.forceMkdir(workspacePath);
            this.path = workspacePath.toString();
        } catch (IOException e) {
            // I don't care
        }
